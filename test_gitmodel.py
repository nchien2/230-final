...
visual_embeds = torch.from_numpy(visual_embed_v[:batch_size*num_frames].reshape(batch_size, num_frames, -1))
...
for epoch in range(num_epochs):
    ...
    batch = {#"visual_embeds": torch.normal(0, 1, size=(25, 3, 768)),
             ...
             "inputs_embeds": torch.normal(0, 1, size=(batch_size, sequence_length, embed_hidden_size)),
             }
