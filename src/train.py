...
if __name__ == "__main__":
    train_ds = SNV3Dataset(
        split="train", vocab_path="vocab_files/train_vocab.pyi", batch_size=batch_size
    )
    valid_ds = SNV3Dataset(
        split="valid", vocab_path="vocab_files/valid_vocab.pyi", batch_size=batch_size
    )
